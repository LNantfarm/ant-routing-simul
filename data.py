...
class AntData:
    ...
    Data clear after some interval
    """

    def __init__(self, lifetime=5, interval=0.1):
        """All data subtrees are empty"""
        self.lifetime = lifetime
        self.interval = interval
        self.numtrees = int(lifetime/interval) + 1
        self.reset()
        self.num_matches = 0

    def __repr__(self):
        return f"{self.special_match}"
    ...
    def _get_size(self, table):
        sizes = tuple(map(len, table))
        if len(sizes) == 0:
            return 0,0
    ...
    def get_sizes(self):
        tables = (self.phero, self.match, self.confirmation,
                  self.special_match)
        return list(map(self._get_size, tables))
    ...
    def get_pheromone(self, pheromone):
        ...
        found = (data and 
                 (p0 and data.pheromone0 or 
                  not p0 and data.pheromone1))
        return (found, data)
